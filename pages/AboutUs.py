...
def app():
    ...
    # Підняти кнопки і збільшити їхню ширину
    st.markdown("<div style='margin-top: 10px;'></div>", unsafe_allow_html=True)

    col_empty, col1, col2, col_empty2 = st.columns([2, 1, 1, 2])
    with col1:
        if st.button("Українська", use_container_width=True, key="ua_btn"):
            st.session_state.language = 'uk'
    with col2:
    ...
    st.markdown(
        ...
        <style>
        div.stButton > button {
            padding: 0.8em 3em; /* Збільшена ширина */
            font-size: 18px;
        }
        </style>
        """,
    ...
    texts = {
        'uk': {
            ...
            'vision': "Візія 👓",
            'vision_text': "Світ, у якому мовне різноманіття сприймається як сила, а кожна людина — незалежно від її здатності чути — має рівний доступ до спілкування, освіти й можливостей.",
            'goal': "Мета 🌍",
            'goal_text': "Сприяти побудові інклюзивного суспільства, де жестова мова є природною частиною взаємодії, а технології стають засобом рівності, підтримки та взаєморозуміння."
        },
        'en': {
            'about_us': "About Us",
            'about_text': (
            ...
            'vision': "Vision 👓",
            'vision_text': "A world where linguistic diversity is embraced as a strength, and every person — regardless of their ability to hear — has equal access to communication, education, and opportunities.",
            'goal': "Goal 🌍",
            'goal_text': "To help build an inclusive society where sign language is a natural part of interaction, and technology becomes a means of equality, support, and understanding."
        }
    }
